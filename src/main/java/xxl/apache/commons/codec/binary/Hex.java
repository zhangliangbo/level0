...
package xxl.apache.commons.codec.binary;
...
public class Hex implements BinaryEncoder, BinaryDecoder {
    ...
    /**
     * Default charset name is {@link xxl.apache.commons.codec.CharEncoding#UTF_8}
     *
     * @since 1.4
     */
     ...
     * @throws xxl.apache.commons.codec.DecoderException Thrown if an odd number or illegal of characters is supplied
     * @since 1.11
     */
    public static byte[] decodeHex(final String data) throws xxl.apache.commons.codec.DecoderException {
     ...
     * @throws xxl.apache.commons.codec.DecoderException Thrown if an odd number or illegal of characters is supplied
     */
    public static byte[] decodeHex(final char[] data) throws xxl.apache.commons.codec.DecoderException {

        final int len = data.length;

        if ((len & 0x01) != 0) {
            throw new xxl.apache.commons.codec.DecoderException("Odd number of characters.");
        }
     ...
     * @return An integer
     * @throws xxl.apache.commons.codec.DecoderException Thrown if ch is an illegal hex character
     */
    protected static int toDigit(final char ch, final int index) throws xxl.apache.commons.codec.DecoderException {
        final int digit = Character.digit(ch, 16);
        if (digit == -1) {
            throw new xxl.apache.commons.codec.DecoderException("Illegal hexadecimal character " + ch + " at index " + index);
        }
        return digit;
    }
     ...
     * @throws xxl.apache.commons.codec.DecoderException Thrown if an odd number of characters is supplied to this function
     * @see #decodeHex(char[])
     */
    @Override
    public byte[] decode(final byte[] array) throws xxl.apache.commons.codec.DecoderException {
     ...
     * @since 1.11
     */
    public byte[] decode(final ByteBuffer buffer) throws xxl.apache.commons.codec.DecoderException {
     ...
     * @return A byte array containing binary data decoded from the supplied byte array (representing characters).
     * @throws xxl.apache.commons.codec.DecoderException Thrown if an odd number of characters is supplied to this function or the object is not
     *                                                   a String or char[]
     * @see #decodeHex(char[])
     */
    @Override
    public Object decode(final Object object) throws xxl.apache.commons.codec.DecoderException {
     ...
     * @return A char[] containing lower-case hexadecimal characters
     * @throws xxl.apache.commons.codec.EncoderException Thrown if the given object is not a String or byte[]
     * @see #encodeHex(byte[])
     */
    @Override
    public Object encode(final Object object) throws xxl.apache.commons.codec.EncoderException {
        byte[] byteArray;
        if (object instanceof String) {
