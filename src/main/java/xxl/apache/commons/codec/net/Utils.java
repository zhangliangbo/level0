...
class Utils {
     ...
     * @throws xxl.apache.commons.codec.DecoderException Thrown when the byte is not valid per {@link Character#digit(char, int)}
     */
    static int digit16(final byte b) throws xxl.apache.commons.codec.DecoderException {
