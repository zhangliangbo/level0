...
public class URLCodec implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder {
     ...
     * @throws xxl.apache.commons.codec.DecoderException Thrown if URL decoding is unsuccessful
     */
    public static final byte[] decodeUrl(final byte[] bytes) throws xxl.apache.commons.codec.DecoderException {
        if (bytes == null) {
            return null;
        }
        final ByteArrayOutputStream buffer = new ByteArrayOutputStream();
        for (int i = 0; i < bytes.length; i++) {
            ...
            if (b == '+') {
                ...
                try {
                    ...
                    throw new xxl.apache.commons.codec.DecoderException("Invalid URL encoding: ", e);
                }
            } else {
                buffer.write(b);
            }
    ...
    public String encode(final String str, final String charsetName) throws UnsupportedEncodingException {
        ...
        return xxl.apache.commons.codec.binary.StringUtils.newStringUsAscii(encode(str.getBytes(charsetName)));
    }
     ...
     * @param str string to convert to a URL safe form
     * @return URL safe string
     * @throws xxl.apache.commons.codec.EncoderException Thrown if URL encoding is unsuccessful
     * @see #getDefaultCharset()
     */
    @Override
    public String encode(final String str) throws xxl.apache.commons.codec.EncoderException {
        if (str == null) {
            return null;
        }
        try {
     ...
     * @throws xxl.apache.commons.codec.EncoderException Thrown if URL encoding is not applicable to objects of this type or if encoding is unsuccessful
     */
    @Override
