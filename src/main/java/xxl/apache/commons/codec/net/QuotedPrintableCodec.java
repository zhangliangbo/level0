...
package xxl.apache.commons.codec.net;

import xxl.apache.commons.codec.*;
...
public class QuotedPrintableCodec implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder {
     ...
     * @throws xxl.apache.commons.codec.DecoderException Thrown if quoted-printable decoding is unsuccessful
     */
    public static final byte[] decodeQuotedPrintable(final byte[] bytes) throws xxl.apache.commons.codec.DecoderException {
        if (bytes == null) {
            return null;
        }
        final ByteArrayOutputStream buffer = new ByteArrayOutputStream();
        for (int i = 0; i < bytes.length; i++) {
            ...
            if (b == ESCAPE_CHAR) {
                try {
                    ...
                    throw new xxl.apache.commons.codec.DecoderException("Invalid quoted-printable encoding", e);
                }
            } else if (b != CR && b != LF) {
     ...
     */
    @Override
    public byte[] decode(final byte[] bytes) throws xxl.apache.commons.codec.DecoderException {
     ...
     * @throws xxl.apache.commons.codec.EncoderException Thrown if quoted-printable encoding is unsuccessful
     * @see #getCharset()
     */
    @Override
    public String encode(final String sourceStr) throws xxl.apache.commons.codec.EncoderException {
     ...
     * @since 1.7
     */
    public String decode(final String sourceStr, final Charset sourceCharset) throws xxl.apache.commons.codec.DecoderException {
        if (sourceStr == null) {
            return null;
        }
        return new String(this.decode(xxl.apache.commons.codec.binary.StringUtils.getBytesUsAscii(sourceStr)), sourceCharset);
    }
    ...
    public String decode(final String sourceStr, final String sourceCharset)
            throws xxl.apache.commons.codec.DecoderException, UnsupportedEncodingException {
        if (sourceStr == null) {
            return null;
        }
        return new String(decode(xxl.apache.commons.codec.binary.StringUtils.getBytesUsAscii(sourceStr)), sourceCharset);
    }
     ...
     * @param sourceStr quoted-printable string to convert into its original form
     * @return original string
     * @throws xxl.apache.commons.codec.DecoderException Thrown if quoted-printable decoding is unsuccessful. Thrown if Charset is not supported.
     * @see #getCharset()
     */
    @Override
    public String decode(final String sourceStr) throws xxl.apache.commons.codec.DecoderException {
     ...
     * @throws xxl.apache.commons.codec.EncoderException Thrown if quoted-printable encoding is not applicable to objects of this type or if encoding is
     *                                                   unsuccessful
     */
    @Override
    public Object encode(final Object obj) throws xxl.apache.commons.codec.EncoderException {
        if (obj == null) {
            return null;
     ...
     * @throws xxl.apache.commons.codec.DecoderException Thrown if the argument is not a {@code String} or {@code byte[]}. Thrown if a failure
     *                                                   condition is encountered during the decode process.
     */
    @Override
    public Object decode(final Object obj) throws xxl.apache.commons.codec.DecoderException {
        if (obj == null) {
            return null;
        } else if (obj instanceof byte[]) {
    ...
    public String encode(final String sourceStr, final Charset sourceCharset) {
        ...
        return xxl.apache.commons.codec.binary.StringUtils.newStringUsAscii(this.encode(sourceStr.getBytes(sourceCharset)));
    }
