...
import xxl.apache.commons.codec.BinaryDecoder;
import xxl.apache.commons.codec.BinaryEncoder;
...
public class PercentCodec implements BinaryEncoder, BinaryDecoder {
     ...
     */
    @Override
    public byte[] encode(final byte[] bytes) throws xxl.apache.commons.codec.EncoderException {
        if (bytes == null) {
            return null;
        }
        ...
        for (int i = 0; i < bytes.length; i++) {
            ...
            if (b == ESCAPE_CHAR) {
                try {
                    ...
                    throw new xxl.apache.commons.codec.DecoderException("Invalid percent decoding: ", e);
                }
            } else {
                if (plusForSpace && b == '+') {
                    buffer.put((byte) ' ');
     ...
     * @throws xxl.apache.commons.codec.EncoderException if the object is not a byte array
     */
    @Override
     ...
     * @throws xxl.apache.commons.codec.DecoderException if the object is not a byte array
     */
    @Override
