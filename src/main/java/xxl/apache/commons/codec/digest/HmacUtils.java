...
public final class HmacUtils {
     ...
     * @since 1.11
     */
    public static boolean isAvailable(final xxl.apache.commons.codec.digest.HmacAlgorithms name) {
        try {
    ...
    public static Mac getHmacMd5(final byte[] key) {
        return getInitializedMac(xxl.apache.commons.codec.digest.HmacAlgorithms.HMAC_MD5, key);
    }
    ...
    public static Mac getHmacSha1(final byte[] key) {
        return getInitializedMac(xxl.apache.commons.codec.digest.HmacAlgorithms.HMAC_SHA_1, key);
    }
    ...
    public static Mac getHmacSha256(final byte[] key) {
        return getInitializedMac(xxl.apache.commons.codec.digest.HmacAlgorithms.HMAC_SHA_256, key);
    }
    ...
    public static Mac getHmacSha384(final byte[] key) {
        return getInitializedMac(xxl.apache.commons.codec.digest.HmacAlgorithms.HMAC_SHA_384, key);
    }
    ...
    public static Mac getHmacSha512(final byte[] key) {
        return getInitializedMac(xxl.apache.commons.codec.digest.HmacAlgorithms.HMAC_SHA_512, key);
    }
     ...
     * @see Mac#init(Key)
     */
    public static Mac getInitializedMac(final xxl.apache.commons.codec.digest.HmacAlgorithms algorithm, final byte[] key) {
    ...
    public static byte[] hmacMd5(final byte[] key, final byte[] valueToDigest) {
        return new HmacUtils(xxl.apache.commons.codec.digest.HmacAlgorithms.HMAC_MD5, key).hmac(valueToDigest);
    }
    ...
    public static String hmacMd5Hex(final byte[] key, final byte[] valueToDigest) {
        return new HmacUtils(xxl.apache.commons.codec.digest.HmacAlgorithms.HMAC_MD5, key).hmacHex(valueToDigest);
    }
    ...
    public static byte[] hmacSha1(final byte[] key, final byte[] valueToDigest) {
        return new HmacUtils(xxl.apache.commons.codec.digest.HmacAlgorithms.HMAC_SHA_1, key).hmac(valueToDigest);
    }
    ...
    public static String hmacSha1Hex(final byte[] key, final byte[] valueToDigest) {
        return new HmacUtils(xxl.apache.commons.codec.digest.HmacAlgorithms.HMAC_SHA_1, key).hmacHex(valueToDigest);
    }
    ...
    public static byte[] hmacSha256(final byte[] key, final byte[] valueToDigest) {
        return new HmacUtils(xxl.apache.commons.codec.digest.HmacAlgorithms.HMAC_SHA_256, key).hmac(valueToDigest);
    }
    ...
    public static String hmacSha256Hex(final byte[] key, final byte[] valueToDigest) {
        return new HmacUtils(xxl.apache.commons.codec.digest.HmacAlgorithms.HMAC_SHA_256, key).hmacHex(valueToDigest);
    }
    ...
    public static byte[] hmacSha384(final byte[] key, final byte[] valueToDigest) {
        return new HmacUtils(xxl.apache.commons.codec.digest.HmacAlgorithms.HMAC_SHA_384, key).hmac(valueToDigest);
    }
    ...
    public static String hmacSha384Hex(final byte[] key, final byte[] valueToDigest) {
        return new HmacUtils(xxl.apache.commons.codec.digest.HmacAlgorithms.HMAC_SHA_384, key).hmacHex(valueToDigest);
    }
    ...
    public static byte[] hmacSha512(final byte[] key, final byte[] valueToDigest) {
        return new HmacUtils(xxl.apache.commons.codec.digest.HmacAlgorithms.HMAC_SHA_512, key).hmac(valueToDigest);
    }
    ...
    public static String hmacSha512Hex(final byte[] key, final byte[] valueToDigest) {
        return new HmacUtils(xxl.apache.commons.codec.digest.HmacAlgorithms.HMAC_SHA_512, key).hmacHex(valueToDigest);
    }
    ...
    public static Mac updateHmac(final Mac mac, final String valueToDigest) {
        mac.reset();
        mac.update(xxl.apache.commons.codec.binary.StringUtils.getBytesUtf8(valueToDigest));
        return mac;
    }
    ...
    public HmacUtils(final String algorithm, final String key) {
        this(algorithm, xxl.apache.commons.codec.binary.StringUtils.getBytesUtf8(key));
    }
     ...
     * @since 1.11
     */
    public HmacUtils(final xxl.apache.commons.codec.digest.HmacAlgorithms algorithm, final String key) {
        this(algorithm.getName(), xxl.apache.commons.codec.binary.StringUtils.getBytesUtf8(key));
    }
    ...
    public String hmacHex(final byte[] valueToDigest) {
        return xxl.apache.commons.codec.binary.Hex.encodeHexString(hmac(valueToDigest));
    }
