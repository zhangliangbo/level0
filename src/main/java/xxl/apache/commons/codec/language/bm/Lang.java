...
package xxl.apache.commons.codec.language.bm;

import xxl.apache.commons.codec.Resources;
...
public class Lang {
    ...
    private static final Map<xxl.apache.commons.codec.language.bm.NameType, Lang> Langs = new EnumMap<>(xxl.apache.commons.codec.language.bm.NameType.class);

    private static final String LANGUAGE_RULES_RN = "org/apache/commons/codec/language/bm/%s_lang.txt";

    static {
        for (final xxl.apache.commons.codec.language.bm.NameType s : xxl.apache.commons.codec.language.bm.NameType.values()) {
            Langs.put(s, loadFromResource(String.format(LANGUAGE_RULES_RN, s.getName()), xxl.apache.commons.codec.language.bm.Languages.getInstance(s)));
        }
    }
     ...
     */
    public static Lang instance(final xxl.apache.commons.codec.language.bm.NameType nameType) {
     ...
     */
    public static Lang loadFromResource(final String languageRulesResourceName, final xxl.apache.commons.codec.language.bm.Languages languages) {
        ...
        try (final Scanner scanner = new Scanner(Resources.getInputStream(languageRulesResourceName),
                xxl.apache.commons.codec.language.bm.ResourceConstants.ENCODING)) {
            ...
            while (scanner.hasNextLine()) {
                ...
                if (inExtendedComment) {
                    ...
                    if (line.endsWith(xxl.apache.commons.codec.language.bm.ResourceConstants.EXT_CMT_END)) {
                        inExtendedComment = false;
                    }
                } else {
                    if (line.startsWith(xxl.apache.commons.codec.language.bm.ResourceConstants.EXT_CMT_START)) {
                        inExtendedComment = true;
                    } else {
                        // discard comments
                        final int cmtI = line.indexOf(xxl.apache.commons.codec.language.bm.ResourceConstants.CMT);
                        if (cmtI >= 0) {
    ...
    private final xxl.apache.commons.codec.language.bm.Languages languages;
    private final List<LangRule> rules;

    private Lang(final List<LangRule> rules, final xxl.apache.commons.codec.language.bm.Languages languages) {
     ...
     *
     * @param text the word
     * @return the language that the word originates from or {@link xxl.apache.commons.codec.language.bm.Languages#ANY} if there was no unique match
     */
    public String guessLanguage(final String text) {
        final xxl.apache.commons.codec.language.bm.Languages.LanguageSet ls = guessLanguages(text);
        return ls.isSingleton() ? ls.getAny() : xxl.apache.commons.codec.language.bm.Languages.ANY;
    }
     ...
     */
    public xxl.apache.commons.codec.language.bm.Languages.LanguageSet guessLanguages(final String input) {
        ...
        final xxl.apache.commons.codec.language.bm.Languages.LanguageSet ls = xxl.apache.commons.codec.language.bm.Languages.LanguageSet.from(langs);
        return ls.equals(xxl.apache.commons.codec.language.bm.Languages.NO_LANGUAGES) ? Languages.ANY_LANGUAGE : ls;
    }
}
