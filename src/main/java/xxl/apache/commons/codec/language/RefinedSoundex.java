 ...
 */
public class RefinedSoundex implements xxl.apache.commons.codec.StringEncoder {
     ...
     * @throws xxl.apache.commons.codec.EncoderException if an error occurs encoding one of the strings
     * @see SoundexUtils#difference(StringEncoder, String, String)
     * @see <a href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/tsqlref/ts_de-dz_8co5.asp">
     * MS T-SQL DIFFERENCE</a>
     * @since 1.3
     */
    public int difference(final String s1, final String s2) throws xxl.apache.commons.codec.EncoderException {
