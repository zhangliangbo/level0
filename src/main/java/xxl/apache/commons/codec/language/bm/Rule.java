...
import xxl.apache.commons.codec.language.bm.Languages.LanguageSet;
...
public class Rule {
    ...
    private static final Map<xxl.apache.commons.codec.language.bm.NameType, Map<xxl.apache.commons.codec.language.bm.RuleType, Map<String, Map<String, List<Rule>>>>> RULES =
            new EnumMap<>(xxl.apache.commons.codec.language.bm.NameType.class);

    static {
        for (final xxl.apache.commons.codec.language.bm.NameType s : xxl.apache.commons.codec.language.bm.NameType.values()) {
            final Map<xxl.apache.commons.codec.language.bm.RuleType, Map<String, Map<String, List<Rule>>>> rts =
                    new EnumMap<>(xxl.apache.commons.codec.language.bm.RuleType.class);

            for (final xxl.apache.commons.codec.language.bm.RuleType rt : xxl.apache.commons.codec.language.bm.RuleType.values()) {
                final Map<String, Map<String, List<Rule>>> rs = new HashMap<>();

                final xxl.apache.commons.codec.language.bm.Languages ls = xxl.apache.commons.codec.language.bm.Languages.getInstance(s);
                ...
                if (!rt.equals(xxl.apache.commons.codec.language.bm.RuleType.RULES)) {
    ...
    private static String createResourceName(final xxl.apache.commons.codec.language.bm.NameType nameType, final xxl.apache.commons.codec.language.bm.RuleType rt, final String lang) {
        return String.format("org/apache/commons/codec/language/bm/%s_%s_%s.txt",
                nameType.getName(), rt.getName(), lang);
    }

    private static Scanner createScanner(final xxl.apache.commons.codec.language.bm.NameType nameType, final xxl.apache.commons.codec.language.bm.RuleType rt, final String lang) {
        final String resName = createResourceName(nameType, rt, lang);
        return new Scanner(xxl.apache.commons.codec.Resources.getInputStream(resName), xxl.apache.commons.codec.language.bm.ResourceConstants.ENCODING);
    }
    ...
    private static Scanner createScanner(final String lang) {
        ...
        return new Scanner(Resources.getInputStream(resName), xxl.apache.commons.codec.language.bm.ResourceConstants.ENCODING);
    }
     ...
     */
    public static List<Rule> getInstance(final xxl.apache.commons.codec.language.bm.NameType nameType, final xxl.apache.commons.codec.language.bm.RuleType rt,
     ...
     * @return a list of Rules that apply
     */
    public static List<Rule> getInstance(final xxl.apache.commons.codec.language.bm.NameType nameType, final xxl.apache.commons.codec.language.bm.RuleType rt, final String lang) {
     ...
     * @since 1.9
     */
    public static Map<String, List<Rule>> getInstanceMap(final xxl.apache.commons.codec.language.bm.NameType nameType, final xxl.apache.commons.codec.language.bm.RuleType rt,
                                                         final LanguageSet langs) {
        return langs.isSingleton() ? getInstanceMap(nameType, rt, langs.getAny()) :
                getInstanceMap(nameType, rt, xxl.apache.commons.codec.language.bm.Languages.ANY);
    }
    ...
    private static Phoneme parsePhoneme(final String ph) {
        ...
        return new Phoneme(ph, xxl.apache.commons.codec.language.bm.Languages.ANY_LANGUAGE);
    }
